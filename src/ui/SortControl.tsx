 ...
 * option reads as a whole, "Sort By Title". The keys and orders are core's
 * (`SEARCH_SORTS`, `LIBRARY_SORTS`); the wording is this client's
 * (`sortChoiceLabel`), because core writes no viewer text (Tom, 2026-09-24).
 *
